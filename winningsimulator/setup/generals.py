...
_ENDPOINTS = {
    ...
    'bot': "wss://bot.generals.io/socket.io/?EIO=3&transport=websocket",
...
ws = create_connection(_ENDPOINTS['bot'])
...
user_id = 'a15cfd6b9f7ed5c6a63b6fcf791bf66f92703965'
username = 'willsalwayswins'

# send(["star_and_rank", userid])
# data = ["set_username", userid, username]
# ws.send(json.dumps(data))

game_id = 'willsalwayswins'
# data = ["set_custom_team", custom_game_id, '3']
# ws.send(json.dumps(data))
...
class Generals(object):
    def __init__(self, userid, username, mode="1v1", gameid=None,
        ...
        print("Connection status: ", ws.connected)
        ...
        if mode == "private":
            ...
            self._send(["join_private", gameid, userid, 'a15cfd6b9f7ed5c6a63b6fcf791bf66f92703965'])

        elif mode == "1v1":
            self._send(["join_1v1", userid, 'a15cfd6b9f7ed5c6a63b6fcf791bf66f92703965']) 

        elif mode == "team":
            if gameid is None:
                raise ValueError("Gameid must be provided for team games")
            self._send(["join_team", gameid, userid, 'a15cfd6b9f7ed5c6a63b6fcf791bf66f92703965'])

        elif mode == "ffa":
            self._send(["play", userid, 'a15cfd6b9f7ed5c6a63b6fcf791bf66f92703965'])
