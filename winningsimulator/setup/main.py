...
generals.Generals('SkdijtajO', 'Jordanform', 'private', gameid = 'willsalwayswins', region='bot')

"""

for oneround in range(0,roundnum):
    # g = generals.Generals('SkdijtajO', 'Jordanform', 'ffa', region='std1')
    g = generals.Generals('SkdijtajO', 'Jordanform', 'private', gameid = 'willsalwayswins', region='bot')
    try:
        steps=[]
